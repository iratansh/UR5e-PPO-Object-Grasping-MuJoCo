"""
Integrated Training Script for UR5e Pick-Placefor RGB rendering issues on Ubuntu
"""
...
class IntegratedTrainer:
    ...
    def reset_training_metrics(self):
        """Reset trainer-level aggregate metrics on phase change."""
    ...
    def create_callbacks(self):
        ...
        class RGBMonitoringCallback(DetailedLoggingCallback):
            ...
            # Allow external reset of accumulated totals on phase change
            def reset_totals(self):
                ...
                if hasattr(self, 'recent_approach_events'):
                    self.recent_approach_events = []
                if hasattr(self, 'recent_contact_events'):
                    self.recent_contact_events = []
        ...
        if self.curriculum_manager is not None:
            def _combined_phase_change_reset():
                ...
                try:
                    ...
                    print(f"   ⚠️ Failed to reset callback totals: {e}")
            self.curriculum_manager.on_phase_change_callback = _combined_phase_change_reset
        ...
        early_stopping_callback = PerformanceEarlyStoppingCallback(
            ...
            performance_window=15,  # Average over 15 evaluations for more stability
            degradation_threshold=0.10,  # Stop only if 10% performance drop - was too sensitive at 5%
...
def main():
    ...
    print("🔧for RGB rendering on Ubuntu")
