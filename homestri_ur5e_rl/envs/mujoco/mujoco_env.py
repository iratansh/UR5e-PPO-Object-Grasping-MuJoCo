"""
MuJoCo Environment Integration for Apple Silicon and Camera Switching
"""
...
def apply_apple_silicon_fixes():
    """Apply comprehensive fixes for Apple Silicon Macs"""
    if platform.system() == "Darwin":
        print("Applying Apple Silicon MuJoCo fixes...")
        
        # Set OpenGL backend to GLFW 
        os.environ["MUJOCO_GL"] = "glfw"
        
        # Disable headless mode to force window creation
        os.environ.pop("MUJOCO_HEADLESS", None)
        
        # Apple Silicon specific OpenGL fixes
        if platform.processor() == "arm":
            # Force OpenGL compatibility profile
            os.environ["MUJOCO_GL_CONTEXT_PROFILE"] = "compatibility"
            os.environ["MUJOCO_GL_CONTEXT_VERSION"] = "3.3"
            
            # Disable problematic extensions
            os.environ["MUJOCO_GL_DISABLE_EXTENSIONS"] = "1"
            
            # Force single-threaded rendering for stability
            os.environ["MUJOCO_GL_SINGLE_THREADED"] = "1"
            
            print(" Apple Silicon OpenGL compatibility fixes applied")
...
class MujocoEnv(BaseMujocoEnv):
    """Superclass for MuJoCo environments with enhanced camera switching."""
    ...
    def switch_camera(self, camera_name: str) -> bool:
        ...
        try:
            ...
            if camera_id >= 0:
                ...
                if hasattr(self.mujoco_renderer, 'camera'):
    ...
    def get_camera_info(self) -> Dict:
        ...
        return {
            "current_camera": self.camera_name,
